      ...
      <TooltipProvider>
        ...
        >
          <div
            ref={ref}
            className={cn(
              "rounded-3xl border border-border bg-background p-2 shadow-sm ring-1 ring-foreground/5 transition-all duration-300",
...
const PromptInputTextarea: React.FC<
  PromptInputTextareaProps & React.ComponentProps<typeof PromptTextarea>
    ...
    return (
      <>
        <PromptInput
          ...
          className={cn(
            "w-full bg-background border-border shadow-sm transition-all duration-300 ease-in-out",
                    ...
                    filePreviews[file.name] && (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="absolute top-1 right-1 rounded-full bg-black/60 p-0.5 opacity-100 transition-opacity"
                        >
              ...
              <div className="flex items-center">
                <button
                  ...
                  className={cn(
                    ...
                    showSearch
                      ? "bg-[#1EAEDB]/10 border-[#1EAEDB] text-[#1EAEDB]"
